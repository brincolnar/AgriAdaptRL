...
class Segment:
    ...
    def _get_single_image(self, file_name, image_dir, label_dir):
        ...
        return img, mask, img_filename, load_time, preprocess_time

    def infer(self, file_name):
        image, mask, filename, load_time, preprocess_time = self._get_single_image(file_name, self.image_dir, self.label_dir)
        ...
        metrics_time = time() - metrics_start



        timing_data = { 'load': load_time, 'preprocess': preprocess_time, 'inference': inference_time, 'postprocess': postprocess_time, 'metrics': metrics_time}

        return results, probs, gt, filename, timing_data
