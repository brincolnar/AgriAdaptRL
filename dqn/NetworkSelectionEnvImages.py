...
class NetworkSelectionEnvImages:
    def __init__(self, image_folder, label_folder, performance_factor, device, model_paths, resize_dim=(84, 84), inference_dim=(512, 512), verbose=False):
        ...
        # For 457 images
        self.energy_costs = { '0%': 0.544, '25%': 0.272, '50%': 0.136, '75%': 0.068 }
    ...
    def load_image(self, filename):
        ...
        return self.transform(image).to(self.device) # will return [3, 84, 84] tensor
    ...
    def get_next_state_reward(self, action):
        ...
        results, _, _, _, timing_data = self.segments[action].infer(filename)
    ...
    def analyze_timing_data(self, warmup_images=10):
        ...
        # Get timing data from environment
        ...
        # First pass: calculate sums and squared sums
