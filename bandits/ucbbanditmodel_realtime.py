...
class ContextBanditUCB:
    ...
    def update(self, action, reward, context):
        """Update the bandit's parameters and return the time taken."""
    ...
    def train(self, epochs):
        ...
        csv_filename = f'ucb_{self.PERFORMANCE_FACTOR}_{timestamp}.csv'
        csv_path = os.path.join('./results/ucb/', csv_filename)
        ...
        with open(csv_path, 'w', newline='') as csvfile:
            ...
            for epoch in range(epochs):
                for image_name in tqdm(self.image_list, desc="Training Progress"):
                    ...
                    update_time = self.update(action, reward, features)
                ...
                # self.write_timing_analysis(timing_stats, performance_metrics, f"./jetson_timing_analysis/ucb_bandit_{self.PERFORMANCE_FACTOR}_timing_analysis.txt")
